    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.IntegerField(choices=[(1, '1-20'), (2, '21-50'), (3, '51-100'), (4, '101+')], default=1)),
                ...
                ('application_required', models.IntegerField(choices=[(1, 'No Application Required'), (2, 'Application Required For Some Positions'), (3, 'Application Required For All Positions')], default=3)),
                ('accepting_members', models.BooleanField(default=False)),
                ('listserv', models.CharField(blank=True, max_length=255)),
                ('image', models.ImageField(blank=True, null=True, upload_to=clubs.models.get_club_file_name)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(default=clubs.models.get_invite_id, max_length=8, primary_key=True, serialize=False)),
                ('active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=clubs.models.get_event_file_name)),
