    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creating_club_permission', models.IntegerField(choices=[(0, 'Creating Club Owner'), (10, 'Creating Club Officers'), (20, 'Creating Club Members')], default=20)),
                ('outside_club_permission', models.IntegerField(choices=[(-1, 'None'), (0, 'Subject Club Owner'), (10, 'Subject Club Officers'), (20, 'Subject Club Members'), (100, 'Public')], default=20)),
