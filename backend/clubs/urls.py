...
from clubs.views import (
    ...
    ClubEventViewSet,
    ClubFairViewSet,
    ClubPublicVisibilityMagicLinkView,
    ClubViewSet,
    ClubVisitViewSet,
    DesignationViewSet,
    EligibilityViewSet,
...
urlpatterns = [
    ...
    path(
        r"clubs/<slug:club_code>/public-visibility/<str:token>/",
        ClubPublicVisibilityMagicLinkView.as_view(),
        name="club-public-visibility",
    ),
    ...
    path(
        r"clubs/email_blast/",
        EmailBlastViewSet.as_view({"post": "email_blast"}),
        name="clubs-email-blast",
    ),
