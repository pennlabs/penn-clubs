    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_years', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='clubs.year')),
            ],
        ),
        migrations.CreateModel(
            name='TargetSchool',
            fields=[
                ...
                ('program', models.CharField(blank=True, max_length=255, null=True)),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubs.club')),
                ('target_schools', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='clubs.school')),
            ],
        ),
        migrations.CreateModel(
            name='TargetMajor',
            fields=[
                ...
                ('program', models.CharField(blank=True, max_length=255, null=True)),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubs.club')),
                ('target_majors', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='clubs.major')),
            ],
        ),
    ]
