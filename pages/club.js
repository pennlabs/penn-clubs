       ...
       <div  style={{padding: "30px 50px"}}>
        <div className="is-flex" style={{justifyContent: "space-between", flexDirection: "row", alignItems: "center", paddingRight: 10}}>
         ...
         <div style={{marginBottom: 20}}>
          {club.tags.map(tag => <span class="tag is-rounded" style={{backgroundColor: CLUBS_PURPLE, color: "#fff", margin: 3,}}>{this.findTagById(tag)} </span>)}
         </div>
         <div className="columns">
          ...
          <div className="column">
            <div className="columns is-desktop">
              <div className="column" style={{backgroundColor: "#f2f2f2", borderRadius: 3, margin: 10}}>
                <div style={{display: "flex", justifyContent: "space-between"}}>
                <b className="is-size-6"> Membership: </b>
                <span class="tag is-rounded has-text-dark" style={{backgroundColor: "#ccc", color: "#fff", margin: 3,}}>{this.mapSize(this.size)} </span>
                </div>
                <div style={{display: "flex", justifyContent: "space-between"}}>
                <b className="is-size-6"> Requires Application: </b>
                <span class="tag is-rounded has-text-dark" style={{backgroundColor: "#ccc", color: "#fff", margin: 3,}}>{club.application_required ? "Yes" : "No"} </span>

                </div>
                <div style={{display: "flex", justifyContent: "space-between"}}>
                <b className="is-size-6"> Currently Recruiting </b>
                <span class="tag is-rounded has-text-dark" style={{backgroundColor: "#ccc", color: "#fff", margin: 3,}}>{club.accepting_applications ? "Yes" : "No"} </span>
