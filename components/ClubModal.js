          ...
          <div style={{padding: "20px 40px"}}>
            ...
            <div className="columns">
              ...
              <div className="column is-8-desktop is-7-mobile" style={{display:"flex", flexDirection:"column", justifyContent: "space-between", height: 400}}>
                <p className="has-text-justified is-size-6-desktop is-size-7-touch" style={{height: 370, overflowY: "auto", color: CLUBS_GREY_LIGHT}} dangerouslySetInnerHTML={{__html: description}}></p>
